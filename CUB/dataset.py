...
def load_data(pkl_paths, use_attr, no_img, batch_size, uncertain_label=False, n_class_attr=2, image_dir='images', resampling=False, resol=299, args=None):
    """
    ...
    if 'vit_b16' in args.backbone or 'vit_l16' in args.backbone:
        if is_training:
